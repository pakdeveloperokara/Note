...
class _NoteListState extends State<NoteList> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Linktonotedetail(Note('','',2),"Add Note");
        },
        tooltip: "FAB Click",
        ...
        return Card(
          ...
          child: ListTile(
            ...
            onTap: () {
              ...
              Linktonotedetail(this.noteList[position],"Edit Note");
            },
          ),
        );
      },
  ...
  void Linktonotedetail(Note note,String pageTitle) async
  {
    bool result = await Navigator.push(context, MaterialPageRoute(builder: (context){
      return NoteDetail(note,pageTitle);
    }));
    if(result==true){
      updateListView();
    }
